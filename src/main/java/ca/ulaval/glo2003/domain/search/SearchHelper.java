...
public class SearchHelper {
  ...
  BiPredicate<Restaurant,String> nameFilter=(restaurant , name) ->Util.containsSubstr_toLowerC(restaurant.getName(), name);
  BiPredicate<Restaurant, LocalTime> openedFromFilter=(restaurant ,from) -> restaurant.getHours().getClose().isAfter(from);
  BiPredicate<Restaurant, LocalTime> openedToFilter=(restaurant , to) -> restaurant.getHours().getClose().equals(to) || restaurant.getHours().getClose().isAfter(to);
